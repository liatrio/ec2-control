...
non_critical_instance_ids = map(lambda i: i['InstanceId'], non_critical_instances)

if not list(non_critical_instance_ids):
  print('No instance need to be stopped')
else:  
  client.stop_instances(InstanceIds=list(non_critical_instance_ids))
